...
<div class="container">
    ...
    <form action="update-office" method="post">
        <div class="form-row">
            <div class="form-group col-md-4">
                <label for="offCode" class="ml-2">OFFICE CODE: <span style="color: red">*</span></label>
                <input type="text" name="offCode" class="form-control" id="offCode" readonly placeholder="Your office code" value="${office.officeCode}" required >
            </div>
            <div class="form-group col-md-4">
                <label for="city" class="ml-2">CITY: <span style="color: red">*</span></label>
                <input type="text" name="city" class="form-control" id="city" placeholder="Your office city" value="${office.city}" required>
            </div>
            <div class="form-group col-md-4">
                <label for="country" class="ml-2">COUNTRY: <span style="color: red">*</span></label>
                <input type="text" name="country" class="form-control" id="country" placeholder="Your office country" value="${office.country}" required>
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-4">
                <label for="phone" class="ml-2">PHONE: <span style="color: red">*</span></label>
                <input type="text" name="phone" class="form-control" id="phone" placeholder="Your office phone number" value="${office.phone}" required>
            </div>
            <div class="form-group col-md-4">
                <label for="state" class="ml-2">STATE: </label>
                <input type="text" name="state" class="form-control" id="state" placeholder="Your office state" value="${office.state}">
            </div>
            <div class="form-group col-md-4">
                ...
                <input type="text" name="territory" class="form-control" id="territory"
                       placeholder="Your office territory" value="${office.territory}" required>
            </div>
        </div>
        ...
        <div class="form-row mb-2">
            <div class="from-group col-md-6">
                ...
                <textarea class="form-control" name="address1" id="address1" rows="5"
                          placeholder="Your office address line1" required >${office.addressLine1}</textarea>
            ...
            <div class="from-group col-md-6">
                ...
                <textarea class="form-control" name="address2" id="address2" rows="5"
                          placeholder="Your office address line2(floor, level etc.)">${office.addressLine2}</textarea>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" name="postalCode" class="form-control" id="postalCode"
                       placeholder="Your office postal code" value="${office.postalCode}" required>
            </div>
            <div class="col-3"></div>
            <div class="col-3 d-flex p-3 align-items-end justify-content-end">
                <button type="submit" class="btn btn-danger ">UPDATE OFFICE</button>
            </div>
        </div>
